...
// CODE HERE
let multiply = (num1, num2, callBackfn) => {
...
// CODE HERE 
let each = (arr,cb) => arr.forEach((arr,i) => cb(arr,i))
...
each(names, (items,index) => console.log(`This item at index ${index} is ${items}`)) 
...
let add11 = addingFactory(11)

console.log(add11(22))